                    ...
                    <CardContent className="p-3 print:p-4">
                        <div className="print-header mb-3">
                            <div className="flex justify-between items-start mb-2">
                                <div className="flex items-center gap-2"><Image src="/images/warp-logo.png" alt="WARP Segurança Eletrônica" width={708} height={256} quality={100} className="h-8 w-auto print:h-10" /></div>
                        ...
                        <div className="space-y-3 print:space-y-2">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 print:gap-2">
                                <div className="border border-red-200 p-3 rounded print:p-2"><p className="text-xs font-medium mb-2">ASSINATURA (TÉCNICO RESPONSÁVEL):</p><div className="h-12 print:h-8"></div><div className="border-t border-red-200 pt-1"><p className="text-xs text-center">WARP SEGURANÇA ELETRÔNICA</p></div></div>
                                <div className="border border-red-200 p-3 rounded print:p-2"><p className="text-xs font-medium mb-2">ACEITE E ASSINATURA DO CLIENTE:</p><div className="h-12 print:h-8"></div><div className="border-t border-red-200 pt-1"><p className="text-xs text-center">CLIENTE</p></div></div>
                            </div>
                        </div>
