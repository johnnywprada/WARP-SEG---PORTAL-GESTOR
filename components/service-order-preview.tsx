...
interface ServiceOrderPreviewProps {
    serviceOrderData: ServiceOrderData; // RECEBE O OBJETO INTEIRO FINAL
    onBack: () => void
}
                    ...
                    <CardContent className="p-3 print:p-4">
                        <div className="print-header mb-3">
                            ...
                            <div className="bg-red-50 border border-red-200 rounded p-1.5 mb-2">
                                <div className="text-xs text-gray-700 flex flex-wrap gap-x-3 gap-y-0">
                                    ...
                                    <span>
                                        <strong>End.:</strong> Rua Barros Cassal, 35 - Jardim Bom Clima
                                    </span>
                                    <span>
                                        <strong>Cidade:</strong> Guarulhos, SP - CEP: 07196-270
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mb-3">
                            ...
                            <div className="bg-gray-50 border border-gray-200 p-1.5 rounded text-xs space-y-0.5">
                                <p>
                                    <strong>Nome/Razão Social:</strong> {serviceOrderData.cliente_nome}
                                </p>
                                {serviceOrderData.cliente_documento && (
                                    <p>
                                        <strong>CPF/CNPJ:</strong> {serviceOrderData.cliente_documento}
                                    </p>
                                )}
                                {serviceOrderData.cliente_endereco && (
                                    <p>
                                        <strong>Endereço:</strong> {serviceOrderData.cliente_endereco}
                                    </p>
                                )}
                                <div className="flex gap-4">
                                    {serviceOrderData.cliente_telefone && (
                                        <span>
                                            <strong>Tel:</strong> {serviceOrderData.cliente_telefone}
                                        </span>
                                    )}
                                    {serviceOrderData.cliente_email && (
                                        <span>
                                            <strong>E-mail:</strong> {serviceOrderData.cliente_email}
                                        </span>
                                    )}
                                </div>
                            </div>
                        ...
                        <div className="mb-3">
                            ...
                            <div className="bg-gray-50 border border-gray-200 p-1.5 rounded text-xs space-y-1">
                                <p>
                                    ...
                                    {serviceTypeLabels[serviceOrderData.servicetype as keyof typeof serviceTypeLabels] || serviceOrderData.servicetype}
                                </p>
