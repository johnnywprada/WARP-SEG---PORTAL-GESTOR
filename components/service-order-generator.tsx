...
export function ServiceOrderGenerator({ onBackToMenu, onViewOSList, onLogout }: ServiceOrderGeneratorProps) {
  ...
  const handleGenerateOS = async () => {
    if (!serviceOrderData.cliente_nome.trim()) { alert("Por favor, selecione ou cadastre um cliente."); return; }
    if (!serviceOrderData.servicetype.acao) { alert("Por favor, selecione uma Ação para o serviço."); return; }
    ...
    try {
      ...
      alert(`Ordem de Serviço ${serviceOrderData.osnumber} salva com sucesso!`);
      setShowPreview(true);
    } catch (error: any) {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto p-6 max-w-4xl">
        <div className="mb-8 text-center"><h1 className="text-3xl font-bold text-red-600 mb-2">Gerar Nova Ordem de Serviço</h1><p className="text-muted-foreground">Preencha os dados abaixo</p></div>
        <div className="space-y-6">
          ...
          <div className="flex gap-4 justify-end">
            <Button onClick={handleGenerateOS} disabled={isGenerating} className="gap-2 bg-red-600 hover:bg-red-700">
